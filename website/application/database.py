...
class DataBase:
    ...
    def clear_all_messages(self, name):
        ...
        :return: None
        """
        query = f"DELETE FROM {PLAYLIST_TABLE} WHERE NAME = ?"
        self.cursor.execute(query, (name,))
        self.conn.commit()

    def clear_message(self, name, msg, time):
        """
        ...
        :return: None
        """
        query = f"DELETE FROM {PLAYLIST_TABLE} WHERE NAME = ? AND CONTENT = ? TIME = ?"
        self.cursor.execute(query, (name, msg, time))
        self.conn.commit()
    ...
    def closeDatabase(self):
        ...
        :return: None
        """
        query = f"DELETE FROM {PLAYLIST_TABLE}"
        self.cursor.execute(query)
        self.conn.commit()
